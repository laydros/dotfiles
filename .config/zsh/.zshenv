...
#
# zshenv (XDG location) — sourced on every zsh invocation.
# A 2-line stub at $HOME/.zshenv sets ZDOTDIR and hands off here so that
# child shells (which inherit ZDOTDIR) still find this file.
